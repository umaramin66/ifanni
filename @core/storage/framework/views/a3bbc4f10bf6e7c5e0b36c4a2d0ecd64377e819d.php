...
<?php endif; ?>
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(route('admin.edit.service.attribute.offline.and.online',$get_service->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-xl-4 margin-top-50">
                            <div class="edit-service-wrappers">
                                ...
                                <div class="btn-wrapper margin-top-40">
                                    <button type="submit" class="btn btn-sm btn-success"><?php echo e(__('Save & Publish')); ?></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-8 margin-top-50">
                            <?php if($get_service->is_service_online == 1): ?>
                                <div class="dashboard-switch-single margin-bottom-30">
                                    <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" checked disabled/> <?php echo e(__('Online To Offline Service')); ?>

                                    <label class="switch-label" for="is_service_online"></label>
                                </div>
                            <?php else: ?>
                                <div class="dashboard-switch-single margin-bottom-30">
                                    <input class="custom-switch is_service_online" id="is_service_online" type="checkbox" checked/> <?php echo e(__('Offline To Online Service')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/backend/pages/services/admin-service/edit_service_attributes_offline_and_online_by_id.blade.php ENDPATH**/ ?>