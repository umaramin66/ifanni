...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Delivered Orders')); ?>
                            ...
                            <div>
                                <div class="table-responsive table-responsive--md">
                                    <table id="deliver_order_table" class="custom--table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $deliver_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <?php if($order->status == 3): ?> <td class="order-deliver" data-label="<?php echo e(__('Order Status')); ?>"><span><?php echo e(__('Delivered')); ?></span></td><?php endif; ?>
                                                    <td data-label="<?php echo e(__('Action')); ?>">
                                                        ...
                                                        <a href="#0" class="edit_status_modal" data-toggle="modal"
                                                            data-target="#editStatusModal" data-id="<?php echo e($order->id); ?>">
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/order/deliver-orders.blade.php ENDPATH**/ ?>