                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                <h2 class="dashboards-title"> <?php echo e(__('Job Request Conversation Details')); ?> </h2>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        <div class="header-wrap d-flex justify-content-between">
                                            <h4 class="header-title"><?php echo e(__('Job Request Conversation Details')); ?></h4>
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(route('admin.jobs.all')); ?>"><?php echo e(__('All Jobs')); ?></a>
                                        </div>

                                        <div class="gig-order-info">
                                            <p><strong><?php echo e(__('Request ID:')); ?></strong> #<?php echo e($request_details->id); ?></p>
                                            <p><strong><?php echo e(__('Job ID:')); ?></strong> #<?php echo e($request_details->job_post_id); ?></p>
                                            <p><strong><?php echo e(__('Job Title:')); ?></strong> #<?php echo e(optional($request_details->job)->title); ?></p>
                                            <p><strong><?php echo e(__('Seller Budget:')); ?></strong> <?php echo e(float_amount_with_currency_symbol($request_details->expected_salary)); ?></p>
                                        </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/Modules/JobPost/Resources/views/backend/view-conversation.blade.php ENDPATH**/ ?>