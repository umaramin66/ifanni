...
<?php $__env->startSection('page-meta-data'); ?>
    <?php echo render_site_title($child_category->name); ?>

    <meta name="title" content="<?php echo e($child_category->name); ?>">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php if($all_services->count() >= 1): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <div class="alert alert-warning"><?php echo e(sprintf(__('No services found in %s'),optional($child_category)->name)); ?></div>
                <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/pages/services/child-category-services.blade.php ENDPATH**/ ?>