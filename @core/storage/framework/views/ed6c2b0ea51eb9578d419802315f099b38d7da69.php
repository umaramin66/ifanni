                            ...
                            <div>
                                <div class="table-responsive table-responsive--md">
                                    <table id="cancel_order_table" class="custom--table">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $cancel_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <?php if($order->status == 4): ?> <td class="canceled" data-label="<?php echo e(__('Order Status')); ?>"><span><?php echo e(__('Cancelled')); ?></span></td><?php endif; ?>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/order/cancel-orders.blade.php ENDPATH**/ ?>