                        ...
                        <div class="col-xl-8 margin-top-50">
                            ...
                            <?php if($service_additionals->count() >= 1): ?>
                                <div class="single-settings margin-top-40">
                                    <h4 class="input-title"> <?php echo e(__('Additional Services')); ?> </h4>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/backend/pages/services/admin-service/edit_service_attributes_by_id.blade.php ENDPATH**/ ?>