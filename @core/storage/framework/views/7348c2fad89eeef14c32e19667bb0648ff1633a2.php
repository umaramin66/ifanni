...
<?php endif; ?>
                                        ...
                                        <?php if($request_details): ?>
                                            <div class="gig-order-info">
                                                ...
                                                <p><strong><?php echo e(__('Cover Letter:')); ?></strong> <?php echo e($request_details->cover_letter); ?></p>
                                                 <p>
                                                     <strong><?php echo e(__('Offer Price:')); ?></strong>
                                                     <b><?php echo e(float_amount_with_currency_symbol($request_details->expected_salary)); ?></b>

                                                <?php if($request_details->is_hired != 1): ?>
                                                     <a href="#0" class="edit_offer_price"
                                                        data-toggle="modal"
                                                        data-target="#editOfferPrice"
                                                        data-id="<?php echo e($request_details->id); ?>"
                                                        data-expected_salary="<?php echo e($request_details->expected_salary); ?>"                                                     >
    ...
    <div class="modal fade" id="editOfferPrice" tabindex="-1" role="dialog" aria-labelledby="editOfferPrice" aria-hidden="true">
        <form action="<?php echo e(route('seller.job.offer.price.edit')); ?>" method="post">
            <input type="hidden" id="up_id" name="up_id" >
            <?php echo csrf_field(); ?>
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editOfferPrice"><?php echo e(__('Edit Job Offer Price')); ?></h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group mt-3">
                            <label for="expected_salary"><?php echo e(__('Offer Price')); ?></label>
                            <input type="text" name="expected_salary" id="expected_salary" class="form-control" placeholder="<?php echo e(__('Offer Price')); ?>">
                        </div>
                    </div>
