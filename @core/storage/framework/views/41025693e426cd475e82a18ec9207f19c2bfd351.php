...
<?php endif; ?>
                                ...
                                <div class="card-body">
                                    <div class="gig-chat-message-heading">
                                        <div class="header-wrap d-flex justify-content-between">
                                            ...
                                            <?php else: ?>
                                                <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#addCouponModal"><?php echo e(__('Hire Now')); ?></button>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <?php if($request_details): ?>
                                            <div class="gig-order-info">
                                                ...
                                                ?>
                                                <p><strong><?php echo e(__('Tax:')); ?></strong> <?php echo e(float_amount_with_currency_symbol( $tax)); ?></p>
                                                <p><strong><?php echo e(__('Total:')); ?></strong> <?php echo e(float_amount_with_currency_symbol($salary+$tax)); ?></p>
                                        ...
                                        <div class="reply-message-wrap ">
                                            ...
                                            <form action="<?php echo e(route('buyer.job.request.message.send')); ?>" method="post" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                                <?php if($request_details): ?>
    ...
    <div class="modal fade" id="addCouponModal" tabindex="-1" role="dialog" aria-labelledby="couponModal" aria-hidden="true">
        <form id="msform" class="ms-order-form" action="<?php echo e(route('buyer.job.request.seller.hired',$request_details->id)); ?>" method="post"  enctype="multipart/form-data">
            <?php echo csrf_field(); ?>

            <input type="hidden" value="<?php echo e($request_details->id); ?>" name="request_id">
            <input type="hidden" value="<?php echo e($request_details->job_post_id); ?>" name="job_post_id">
            <input type="hidden" value="<?php echo e($request_details->expected_salary); ?>" name="expected_salary">

            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-warning" id="couponModal"><?php echo e(__('At First Complete Your Payment and Only You Can Place an Order.')); ?></h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary order_create_from_jobs"><?php echo e(__('Place Order')); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/Modules/JobPost/Resources/views/frontend/buyer/conversation.blade.php ENDPATH**/ ?>