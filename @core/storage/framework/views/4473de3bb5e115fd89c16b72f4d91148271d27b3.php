                            ...
                            <div>
                                    ...
                                    <table id="complete_order_table" class="custom--table">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php if(request()->path() == 'seller/orders/job/complete-orders'): ?>
                                                    <!--job order title -->
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $complete_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td data-label="<?php echo e(__('Buyer Name')); ?>"> <?php echo e($order->name); ?> </td>
                                                    ...
                                                    <?php if($order->status == 2): ?> <td class="completed" data-label="<?php echo e(__('Order Status')); ?>"><span><?php echo e(__('Completed')); ?></span></td><?php endif; ?>
                                ...
                                <div class="blog-pagination margin-top-55">
                                    <div class="custom-pagination mt-4 mt-lg-5">
                                        <?php echo $complete_orders->links(); ?>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/resources/views/frontend/user/seller/order/complete-orders.blade.php ENDPATH**/ ?>