...
class HeaderStyleCustome extends \App\PageBuilder\PageBuilderBase
{
...
return <<<HTML
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5">
                    <div class="banner-contents style-02">
                        <h2 class="banner-title">{$title_start} <span class="span-shape"> {$title_end} </span> </h2>
    ...
    <div class="banner-area home-two-banner"style="padding: 0px 0px 0px;">
        <div class="container-fuild" >
            <div class="row justify-content-between align-items-center no-gutters">
                <div class="col-xl-6 bg-left">
                
                    <div class="banner-contents style-02">
                    <div class="container">
                        <div class="row">
                            <div class=" col-md-8 mx-auto">
                                <h2 class="banner-title text-dark" style="text-transform: capitalize; font-size: 40px;line-height: 42px;}">{$title_start} <span class="span-shape"> {$title_end} </span> </h2>
                                <p class="fs-18">{$subtitle}</p>
                                <div class="banner-bottom-content">
                                    <div  class="row">
                                        <div class="col-md-12 mx-auto ">
                                            <div class="row">
                                                ...
                                                <div class="btn-wrapper">
                                                    <a href="" class="cmn-btn btn-appoinment btn-bg-1" >Talk to an Expert</a>
                                                </div>
                                                ...
                                                <div class=" col-md-6 col-6 col-xl-6">
                                                    ...
                                                    <div class="btn-wrapper">
                                                        <a href="" class="cmn-btn btn-outline-2">Sign Up</a>
                ...
                <div class="col-xl-6">
                    <div class="banner-right-contents">
                        <div class="banner-right-thumb" style="width: 100%; height: 100%; object-fit:cover;">
                           {$image}
                        </div>
                        <!--<div class="banner-cleaning-service">
                            <div class="icon">
