...
return <<<HTML
    ...
    <div class="banner-area home-two-banner"style="padding: 50px 0px 0px;">
        <div class="container-fuild" style="background-color: #1AD678;">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class=" col-md-8 mx-auto">
                                <h2 class="banner-title text-white" style="text-transform: capitalize; font-size: 40px;
    line-height: 42px;
}">{$title_start} <span class="span-shape"> {$title_end} </span> </h2>
                                <span class="title-top text-white">{$subtitle}</span>
                                <div class="banner-bottom-content">
                                {$country_city_area_show_hide_markup}
                                    <!--<div class="banner-keywords">
                                        <span class="keyword-title"> {$popular} </span>
