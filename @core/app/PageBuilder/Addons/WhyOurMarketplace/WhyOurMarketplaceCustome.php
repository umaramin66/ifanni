...
class WhyOurMarketplaceCustome extends \App\PageBuilder\PageBuilderBase
{
    ...
    public function frontend_render() : string
    {
        ...
        foreach ($repeater_data['title_'] as $key => $title) {
            ...
            $why_our_marketplace_markup.= <<<SERVICE
                <div class="col-xl-3 col-lg-4 col-md-6 margin-top-30">
                    <div class="single-marketplace border wow fadeInUp" data-wow-delay=".2s">
                        <div>
                         {$image}
                        </div>
                        <div class="marketplace-contents">
                            <h5 class="common-title mt-2"> {$inner_title} </h5>
    ...
    <section class="margketplace-area" data-padding-top="{$padding_top}" data-padding-bottom="{$padding_bottom}" style="background-color:{$section_bg}">
        ...
        <div class="container container-two">
            <div class="row flex-row-reverse align-items-center">
                ...
                <div class="col-xl-12 col-lg-12 margin-top-30">
...
HTML;
    ...
    {
        return __('Why Our Marketplace: Custome');
    }
}