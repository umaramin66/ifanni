...
class FeatureServiceCustome extends \App\PageBuilder\PageBuilderBase
{
        ...
        <div class="container container-two"">
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="section-title">
                        <h2 style="font-weight:600!important;" class="text-bold"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia </h2>
            ...
            <div class="row margin-top-50">
                ...
                <div class="single-service {$dot_color_slider}">
                    <a href="" class="service-thumb location_relative service-bg-thumb-format" >
                    ...
                    <div class="services-contents">
                        ...
                        <h5 class="common-title"> <a href=""></a> </h5>
                        <!-- <p class="common-para"> {$description} </p> -->
                        <div class="btn-wrapper">
                            <a href="" class="cmn-btn btn-appoinment btn-bg-1">test</a>
                        </div>
                    </div>
                </div>
            </div>
...
HTML;
    ...
    {
        return __('Featured Service Custome');
    }
}