...
class PageBuilderSetup
{
    private static function register_widgets(): array
    {
        ...
        $addons = [
            ...
            PageBuilder\Addons\FeatureService\FeatureServiceCustome::class,
            ...
            PageBuilder\Addons\WhyOurMarketplace\WhyOurMarketplaceCustome::class,
            PageBuilder\Addons\WhyOurMarketplace\WhyOurMarketplaceReview::class,
            PageBuilder\Addons\BecomeSeller\BecomeSeller::class,
            PageBuilder\Addons\BecomeSeller\BecomeSellerCustome::class,
            PageBuilder\Addons\BecomeSeller\BecomeSellerCustomeTwo::class,
            PageBuilder\Addons\BecomeSeller\BecomeSellerCustomeThree::class,
            ...
            PageBuilder\Addons\About\BrandsCustome::class,
            ...
            PageBuilder\Addons\Header\HeaderStyleCustome::class,
