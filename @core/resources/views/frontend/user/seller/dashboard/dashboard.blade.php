                        ...
                        <div class="col-lg-12">
                            <div class="dashboard-flex-title">
                                <div class="dashboard-settings margin-top-40">
                                    <h2 class="dashboards-title">{{ __('Service Provider Dashboard') }}</h2>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                            <div class="single-orders py-5">
                                ...
                                <div class="orders-flex-content">
                                    ...
                                    <div class="contents">
                                        <h2 class="order-titles text-dark"> {{ $pending_order }} </h2>
                                        <span class="order-para text-dark">{{ __('Order Pending') }} </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                            <div class="single-orders py-5">
                                ...
                                <div class="orders-flex-content">
                                    ...
                                    <div class="contents">
                                        <h2 class="order-titles text-dark"> {{ $complete_order }} </h2>
                                        <span class="order-para text-dark"> {{ __('Order Completed ') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                            <div class="single-orders py-5">
                                ...
                                <div class="orders-flex-content">
                                    ...
                                    <div class="contents">
                                        <h2 class="order-titles text-dark"> {{ float_amount_with_currency_symbol($total_earnings) }} </h2>
                                        <span class="order-para text-dark">{{ __('Total Withdraw') }} </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                            <div class="single-orders py-5">
                                ...
                                <div class="orders-flex-content">
                                    ...
                                    <div class="contents">
                                        <h2 class="order-titles text-dark">{{ float_amount_with_currency_symbol($remaning_balance - $total_earnings) }} </h2>
                                        <span class="order-para text-dark"> {{ __('Remaining Balance') }} </span>
                                    </div>
                                </div>
                            </div>
                        </div>
