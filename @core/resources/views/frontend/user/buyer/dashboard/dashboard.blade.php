                        ...
                        <div class="col-lg-12">
                            <div class="dashboard-flex-title">
                                <div class="dashboard-settings margin-top-40">
                                    <h2 class="dashboards-title">{{ __('Client Dashboard') }}</h2>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                            <div class="single-orders py-5">
                                ...
                                <div class="orders-flex-content">
                                    ...
                                    <div class="contents">
                                        <h2 class="order-titles text-dark"> {{ $active_order }} </h2>
                                        <span class="order-para text-dark">{{ __('Order Active') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                            <div class="single-orders py-5">
                                ...
                                <div class="orders-flex-content">
                                    ...
                                    <div class="contents">
                                        <h2 class="order-titles text-dark">{{ $total_order }} </h2>
                                        <span class="order-para text-dark"> {{ __('Order Total') }} </span>
                                    </div>
                                </div>
                            </div>
                        </div>
