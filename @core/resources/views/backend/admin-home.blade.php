            ...
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            <h2 class="order-titles text-dark">{{ $total_admin }} </h2>
                            <span class="order-para text-dark">{{ __('Total Admin') }} </span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            <h2 class="order-titles text-dark">{{ $total_seller }} </h2>
                            <span class="order-para text-dark"> {{ __('Total Seller') }} </span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            <h2 class="order-titles text-dark"> {{ $total_buyer }} </h2>
                            <span class="order-para text-dark"> {{ __('Total Buyer') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6 margin-top-30 orders-child">
                <div class="single-orders">
                    ...
                    <div class="orders-flex-content">
                        ...
                        <div class="contents">
                            <h2 class="order-titles text-dark">{{ float_amount_with_currency_symbol($total_earning) }} </h2>
                            <span class="order-para text-dark">{{ __('Total Earning') }}</span>
                        </div>
                    </div>
                </div>
            </div>
